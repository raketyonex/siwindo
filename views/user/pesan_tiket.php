...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/tiket.css'); ?>">
</head>
...
<body class="bg-light py-5">
    ...
    <div class="container">
        ...
        <form action="<?= site_url('user/simpan_pesanan'); ?>" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="harga"
                    value="Rp. <?= number_format($wisata['harga'], 0, '.', ''); ?>" readonly>
            </div>
        ...
        <br>
        <a href="<?= site_url('user'); ?>" class="btn btn-danger w-100">Batal</a>
    </div>
    ...
    <script>
        document.getElementById('jumlah_tiket').addEventListener('input', function () {
            ...
            document.getElementById('total_harga').value = "Rp. " + total_harga;
        });
    </script>
